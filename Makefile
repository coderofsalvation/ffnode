...
CFLAGS        = -g -pipe -Os -fomit-frame-pointer -Wall -W -D_REENTRANT -fPIC $(DEFINES)
CXXFLAGS      = -pipe -fpermissive -std=c++0x -Os -fomit-frame-pointer -std=gnu++11 -Wall -W -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -I. -isystem /usr/include/QtWidgets -isystem /usr/include/QtGui -isystem /usr/include/QtCore -I. -isystem /usr/include/libdrm -I. -I/usr/lib/qt5/mkspecs/linux-g++
...
DISTDIR = /mnt/c/Users/Leon/Desktop/projects/FFmpegGUI/.tmp/FFmpegGUI1.0.0
LINK          = g++
LFLAGS        = -Wl,--as-needed -Wl,-O1
LIBS          = $(SUBLIBS) -L -lavdevice -lavformat -lavfilter -lavcodec -lswscale -lavutil -lswresample -lbz2 -lm -lz -ldl /usr/lib/libQt5Widgets.so /usr/lib/libQt5Gui.so /usr/lib/libQt5Core.so /usr/lib/libGL.so -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
FFmpegGUI: ui_filtersList.h ui_filtersWidget.h ui_inspectionWidget.h $(OBJECTS)  
